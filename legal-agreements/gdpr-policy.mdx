...
This GDPR policy discloses the privacy practices for Launch Legends, LLC. (“the Company”) and any affiliates of the Company (“Affiliates”), whether now or hereafter formed. This GDPR Policy applies to information collected on this site (https://www.autheo.com/) and other sites operated by the Company or its Affiliates (collectively “the Sites”). 
...
For all purposes and unless otherwise specifically disclosed herein or to the customer or user, the data controller of this Site is Launch Legends, LLC.
